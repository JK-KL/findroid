...
constructor(
    ...
    val playerGesturesVB
        get() =
            sharedPreferences.getBoolean(
                Constants.PREF_PLAYER_GESTURES_VB,
                true,
            )
    val playerGesturesZoom
        get() =
            sharedPreferences.getBoolean(
                Constants.PREF_PLAYER_GESTURES_ZOOM,
                true,
            )
    val playerGesturesSeek
        get() =
            sharedPreferences.getBoolean(
                Constants.PREF_PLAYER_GESTURES_SEEK,
                true,
            )
    val playerGesturesSeekTrickplay
        get() =
            sharedPreferences.getBoolean(
                Constants.PREF_PLAYER_GESTURES_SEEK_TRICKPLAY,
                true,
            )
    val playerGesturesChapterSkip
        get() =
            sharedPreferences.getBoolean(
                Constants.PREF_PLAYER_GESTURES_CHAPTER_SKIP,
                true,
            )
    ...
    val playerMpvHwdec
        get() =
            sharedPreferences.getString(
                Constants.PREF_PLAYER_MPV_HWDEC,
                "mediacodec",
            )!!
    ...
    val playerMpvAo
        get() =
            sharedPreferences.getString(
                Constants.PREF_PLAYER_MPV_AO,
                "audiotrack",
            )!!
    val playerIntroSkipper
        get() =
            sharedPreferences.getBoolean(
                Constants.PREF_PLAYER_INTRO_SKIPPER,
                true,
            )
    ...
    val showChapterMarkers
        get() =
            sharedPreferences.getBoolean(
                Constants.PREF_PLAYER_CHAPTER_MARKERS,
                true,
            )
    val playerPipGesture
        get() =
            sharedPreferences.getBoolean(
                Constants.PREF_PLAYER_PIP_GESTURE,
                false,
            )
    ...
    val preferredAudioLanguage
        get() =
            sharedPreferences.getString(
                Constants.PREF_AUDIO_LANGUAGE,
                "",
            )!!
    val preferredSubtitleLanguage
        get() =
            sharedPreferences.getString(
                Constants.PREF_SUBTITLE_LANGUAGE,
                "",
            )!!
    ...
    var noPlayedFilter
        get() =
            sharedPreferences.getBoolean(
                Constants.PREF_PLAYED_FILTER,
                false,
            )
        set(value) {
            sharedPreferences.edit {
                putBoolean(Constants.PREF_PLAYED_FILTER, value)
            }
        }
